...
import cirq
# qusetta is not on PyPI and is only needed by random_Clifford_shadow (qiskit -> cirq
# conversion); the 40-qubit demo loads pre-generated shadows, so make it optional.
try:
    from qusetta import Qiskit
    from qusetta import Cirq, Quasar
except ImportError:
    Qiskit = Cirq = Quasar = None
